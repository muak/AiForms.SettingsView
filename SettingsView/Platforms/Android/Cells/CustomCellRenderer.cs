...
namespace AiForms.Renderers.Droid
{
    ...
    public class CustomCellView : CellBaseView
    {
        ...
        protected override void CreateContentView()
        {
            ...
            _coreView = FindViewById<LinearLayout>(global::AiForms.SettingsView.Resource.Id.CellBody);
            ...
            if(CustomCell.UseFullSize)
            {
                ...
                var layout = FindViewById<ARelativeLayout>(global::AiForms.SettingsView.Resource.Id.CellLayout);
