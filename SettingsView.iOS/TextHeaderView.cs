...
namespace AiForms.Renderers.iOS
{
	public class TextHeaderView : UITableViewHeaderFooterView
	{
		...
		public void UpdateTextAllignment(Section section)
		{
			if ( section is null ) return;
			UpdateTextAllignment(section.TextAlignment);
		}
		public void UpdateTextAllignment(TextAlignment alignment)
		{
			Label.TextAlignment = CellBaseView.GetTextAllignment(alignment);
		}
