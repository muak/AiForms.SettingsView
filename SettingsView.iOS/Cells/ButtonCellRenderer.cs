...
namespace AiForms.Renderers.iOS
{
	...
	{
		public UIButton TitleButton { get; private set; }
		Action _Execute { get; set; }
		...
		{
			TitleLabel.TextAlignment = GetTextAllignment(_ButtonCell.ValueTextAlignment);
			TitleLabel.TextAlignment = GetTextAllignment(_ButtonCell.TitleAlignment);
			TitleButton.TitleLabel.TextAlignment = GetTextAllignment(_ButtonCell.ValueTextAlignment);
			TitleButton.TitleLabel.TextAlignment = GetTextAllignment(_ButtonCell.TitleAlignment);
		}
